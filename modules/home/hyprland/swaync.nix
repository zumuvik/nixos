...

{
  home.file = {
    ...
    @define-color wallust-bg-alt #24283b;
    @define-color wallust-fg #c0caf5;
    @define-color wallust-color12 #7aa2f7;

    @define-color noti-border-color @wallust-color12;
    @define-color noti-bg rgba(0, 0, 0, 0.8);
    @define-color noti-bg-alt @wallust-bg-alt;
    @define-color noti-bg-hover @wallust-bg;
    @define-color text-color @wallust-fg;
