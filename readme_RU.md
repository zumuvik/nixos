...
| `nixlensk323` | Игровой ПК | Steam, AMD Vega 56 (llama.cpp), Hyprland |

## nixlensk323: Специальная конфигурация для LLM вывода

- **GPU**: AMD Radeon RX Vega 56 (8GB VRAM)
- **Runtime**: llama.cpp (v8667, ROCm-enabled)
- **Модель**: DeepSeek-Coder-V2-Lite (16B параметров, IQ2_XS квантизация)
- **API**: REST на localhost:8080
- **Интеграция**: OpenCode для AI разработки

Смотри [`QUICKSTART.sh`](./QUICKSTART.sh) и [`LLAMA_OPENCODE_INTEGRATION.md`](./LLAMA_OPENCODE_INTEGRATION.md) для подробного руководства.
...
├── QUICKSTART.sh              # Быстрая установка llama.cpp + OpenCode
├── SETUP_MANUAL.md            # Пошаговое руководство установки
└── LLAMA_OPENCODE_INTEGRATION.md # Руководство интеграции LLM
```
